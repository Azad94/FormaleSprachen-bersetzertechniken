...
public class calcParser extends Parser {
	...
	public static final int
		T__3=1, T__2=2, T__1=3, T__0=4, SMA=5, GRE=6, EXP=7, MUL=8, DIV=9, ADD=10, 
	...
	public final ProgContext prog() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__3) | (1L << T__2) | (1L << SUB) | (1L << ID) | (1L << INT) | (1L << NEWLINE))) != 0) );
			}
		}
	...
	public static class CleanContext extends StatContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof calcListener ) ((calcListener)listener).enterClean(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof calcListener ) ((calcListener)listener).exitClean(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof calcVisitor ) return ((calcVisitor<? extends T>)visitor).visitClean(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class SmaGreContext extends ExprContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof calcListener ) ((calcListener)listener).enterSmaGre(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof calcListener ) ((calcListener)listener).exitSmaGre(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof calcVisitor ) return ((calcVisitor<? extends T>)visitor).visitSmaGre(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	private ExprContext expr(int _p) throws RecognitionException {
		...
		try {
			...
			case SUB:
				...
				setState(28); ((SubContext)_localctx).op = match(SUB);
				setState(29); expr(4);
				}
				break;
			case INT:
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						setState(39); ((ExpContext)_localctx).op = match(EXP);
						setState(40); expr(8);
						}
						break;
					case 2:
	...
	public static final String _serializedATN =
		...
		"\7\20\2\2\21\32\3\2\2\2\22\23\7\16\2\2\23\24\7\6\2\2\24\25\5\b\5\2\25"+
		"\26\7\20\2\2\26\32\3\2\2\2\27\32\7\20\2\2\30\32\5\6\4\2\31\17\3\2\2\2"+
		"\31\22\3\2\2\2\31\27\3\2\2\2\31\30\3\2\2\2\32\5\3\2\2\2\33\34\7\3\2\2"+
		"\34\7\3\2\2\2\35\36\b\5\1\2\36\37\7\r\2\2\37\'\5\b\5\6 \'\7\17\2\2!\'"+
		"\7\16\2\2\"#\7\4\2\2#$\5\b\5\2$%\7\5\2\2%\'\3\2\2\2&\35\3\2\2\2& \3\2"+
